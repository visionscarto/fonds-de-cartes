...
lee:
	./bin/screenshot.js "http://localhost/maps/fonds-de-cartes/fond.html?projection=PolyhedralLee&graticule=1&antarctica=1&rotate=-30&orient=180&lang=$$LANG" "build/$$LANG/visionscarto-lee" 2
